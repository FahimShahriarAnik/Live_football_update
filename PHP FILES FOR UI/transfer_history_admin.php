...
<body>
    ...
    <br><br>
        <form method="post" action="transfer_form.php">
         <b>Enter Player ID   : </b><input type="number" name="p_name"><br><br>
         <b>Enter New Team ID: </b><input type="number" name="p_team"><br><br>
